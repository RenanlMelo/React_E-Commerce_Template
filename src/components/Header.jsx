    ...
    return (
        <>
            <div className='px-32 flex justify-between gap-x-20 items-center h-full mx-auto z-20'>
                ...
                <navbar ref={navbarRef} className='flex gap-x-6 text-[#242432] justify-center items-center py-4'>
                    ...
                    <AnimatePresence>
                        {dropDown && (
                            <motion.div
                                ...
                                className='z-10 absolute left-0 bg-[#f0f0f0] w-40 h-48'
                                style={{ top: navbarHeight - 15, left: dropDownX }}>
                                <ul className='text-lg text-[#161620] font-semibold flex flex-col justify-center items-center h-full'>
                                    <li className='w-full h-full flex justify-center items-center border-transparent hover:border-transparent duration-200'>
